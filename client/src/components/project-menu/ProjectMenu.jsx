...
export function ProjectMenu() {
  ...
  return (
    <>
      {openMenu ? (
        <>
          <button className="button hamburger open" id="closed-menu" onClick={closeProjectMenu}>
        ...
        <>
          <button className="button hamburger" id="opened-menu" onClick={openProjectMenu}>
